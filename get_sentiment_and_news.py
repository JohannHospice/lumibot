...
class GetSentimentAndNews():
    ...
    def get_news_and_sentiment(self, dates: Tuple[str, str]) -> Tuple[List[str], float, str, int]:
...
class GetSentimentAndNewsCached(GetSentimentAndNews):
    ...
    def get_news_and_sentiment(self, dates: Tuple[str, str]) -> Tuple[List[str], float, str, int]:
        ...
        news_headlines, probability, sentiment, num_headlines = super().get_news_and_sentiment((to_date, from_date))
        
        self._write_cache_news_and_sentiment(cache_file, probability, sentiment, news_headlines)
    ...
    def _write_cache_news_and_sentiment(self, cache_file, probability, sentiment, news_headlines):
